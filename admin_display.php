...
<!DOCTYPE html>
    ...
    <body>
        <div class="boxes">
            <div class="button" style="float: right;"><a href="logout.php"><input type="button" id="button" value="LOGOUT"></a><hr><br><br>
                <h1 style="color: white ; text-align:left">Details of Admin</h1>
                    <!-- TABLE CONSTRUCTION -->
                <table class="table1">
                    <tr>
                        <th>Name</th>
                ...
                <h1 style="color: white;">Details of Doctors</h1>
                <!-- TABLE CONSTRUCTION -->
                <table class="table1">
                    <tr>
                        <th>Name</th>
        ...
        <div class="container">
            <div class="right">
                <h1 class="register-title">Registration</h1><br><br>
                    <div class="form">
